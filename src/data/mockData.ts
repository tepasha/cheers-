...
export const INITIAL_CHATS: ChatThread[] = [
  {
    id: 'chat-group-podil',
    isGroup: true,
    groupName: '🍻 Крафтовий двіж на Подолі',
    groupTopic: 'Крафт, настілки та дегустації IPA',
    groupAvatar: 'https://images.unsplash.com/photo-1514933651103-005eec06c04b?w=500&auto=format&fit=crop&q=80',
    buddy: {
      ...INITIAL_BUDDIES[0],
      name: 'Крафтовий двіж на Подолі',
      tagline: 'Груповий чат • 4 учасники',
      locationName: 'Поділ, Київ',
      avatar: 'https://images.unsplash.com/photo-1514933651103-005eec06c04b?w=500&auto=format&fit=crop&q=80',
    },
    lastMessage: 'Богдан: Забронював стіл на 19:30 у Squat 17b! Хто буде — маякніть 🍻',
    lastMessageTime: '18:50',
    unreadCount: 2,
    participants: [
      {
        id: 'buddy-1',
        name: 'Богдан',
        avatar: INITIAL_BUDDIES[0].avatar,
        online: true,
        role: 'admin',
      },
      {
        id: 'buddy-2',
        name: 'Олена',
        avatar: INITIAL_BUDDIES[1].avatar,
        online: true,
        role: 'member',
      },
      {
        id: 'buddy-3',
        name: 'Тарас',
        avatar: INITIAL_BUDDIES[2].avatar,
        online: false,
        role: 'member',
      },
      {
        id: 'buddy-5',
        name: 'Софія',
        avatar: INITIAL_BUDDIES[4].avatar,
        online: true,
        role: 'member',
      },
    ],
    messages: [
      {
        id: 'mg-1',
        chatId: 'chat-group-podil',
        senderId: 'buddy-1',
        senderName: 'Богдан',
        senderAvatar: INITIAL_BUDDIES[0].avatar,
        text: 'Всім привіт! Хто сьогодні ввечері готовий зустрітися за келихом крафту?',
        timestamp: '18:30',
        isMe: false,
      },
      {
        ...
        senderId: 'buddy-5',
        senderName: 'Софія',
        senderAvatar: INITIAL_BUDDIES[4].avatar,
        text: 'Я візьму настілку Catan! Можемо сісти у затишному дворику 🎲',
        timestamp: '18:35',
        isMe: false,
      },
      {
        ...
        senderName: 'Богдан',
        senderAvatar: INITIAL_BUDDIES[0].avatar,
        text: 'Забронював стіл на 19:30 у Squat 17b! Хто буде — маякніть 🍻',
        timestamp: '18:50',
        isMe: false,
      },
    ],
